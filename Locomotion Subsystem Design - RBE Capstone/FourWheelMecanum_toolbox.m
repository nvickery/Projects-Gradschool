classdef FourWheelMecanum_toolbox < handle
    ...
    properties
        ...
        wheelBase = 0.535;    % Wheelbase [m]
        wheelTrack = 0.459;   % Wheel track [m]
    end
    ...
    methods
        ...
        function obj = FourWheelMecanum_toolbox(wheelRadius,wheelBase,wheelTrack)
        ...
        function computeMatrices(obj)
            ...
            obj.fwdMatrix = [0.0250,  0.0250,  0.0250,  0.0250;
            ...
            obj.invMatrix = [10.0000,  -10.0000,   -4.9700;
                                        10.0000,   10.0000,   -4.9700;
                                        10.0000,  -10.0000,    4.9700;
                                        10.0000,   10.0000,    4.9700]; 
        end
